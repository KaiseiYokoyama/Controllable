...
//            components.add(new TranslationTextComponent("controllable.gui.layout.button", new TranslationTextComponent(Report.Buttons.NAMES[button.getButton()]).mergeStyle(TextFormatting.BLUE)));
